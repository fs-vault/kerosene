...
public class BorderAlternatingComponent extends BorderBase {
    ...
    /**
     * Create an alternating border on the entire {@link Gui} of two specific {@link Material}s.
    ...
    /**
     * Create an alternating border on the entire {@link Gui} of two specific {@link ItemStack}s
    ...
    /**
     * Create an alternating border for a specific region of the {@link Gui} of two specific {@link Material}s
    ...
    /**
     * Create an alternating border for a specific region of the {@link Gui} of two specific {@link ItemStack}s
     * @param x The horizontal start position.
     * @param y The vertical start position.
     * @param width The width of the region to fill.
     * @param height The height of the region to fill.
