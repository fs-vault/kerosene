...
public class BorderComponent extends BorderBase {
    ...
    /**
     * Create a border on the entire {@link Gui} with the {@link GuiDefaults#FILL_ITEM}
     */
    ...
    /**
     * Create a border on the entire {@link Gui} with a fill item of a specific {@link Material}
    ...
    /**
     * Create a border on the entire {@link Gui} with a fill item of a specific {@link ItemStack}
    ...
    /**
     * Create a border around a specific region of the {@link Gui} with {@link GuiDefaults#FILL_ITEM}
     */
    ...
    /**
     * Create a border around a specific region of the {@link Gui} with a specific {@link ItemStack}
     * @param x
     * @param y
     * @param width
     * @param height
